...
document.querySelector('#second_context h1').textContent.split(" ").forEach(function (gap) {
  clutter = clutter + `<span> ${gap} </span>`;
});

// Set the HTML content after building the entire string
document.querySelector("#second_context h1").innerHTML = clutter;

gsap.to("#second_context h1 span", {
  scrollTrigger: {
    trigger: "#second_context h1 span",
    start: "top bottom",
    end: "bottom top",
    scroller: "#container",
    scrub: 0.5,
...
// third page adding the canvas

function canvas1() {
  const canvas = document.querySelector("#third_context canvas");
...
// forth page to split the words and have the gsap working


var clutters = "";

document.querySelector("#forth_context h1").textContent.split("").forEach(function(dets){
    clutters += `<span>${dets}</span>`

    document.querySelector("#forth_context h1 ").innerHTML = clutters;
})

gsap.to("#forth_context h1 span",{
  scrollTrigger:{
      trigger:`#forth_context h1 span`,
      start:`top bottom`,
      end:`bottom top`,
      scroller:`#container`,
      scrub:.5,
...
// fifth page for using the canvas


function canvas2() {
  const canvas = document.querySelector("#fifth_context canvas");
  const context = canvas.getContext("2d");
...
document.querySelector("#sixth_context h1").textContent.split("").forEach(function(dets){
    clutters += `<span>${dets}</span>`

    document.querySelector("#sixth_context h1 ").innerHTML = clutters;
})

gsap.to("#sixth_context h1 span",{
  scrollTrigger:{
      trigger:`#sixth_context h1 span`,
      start:`top bottom`,
      end:`bottom top`,
      scroller:`#container`,
      scrub:.5,
...
// seventh page for using the canvas


function canvas3() {
  const canvas = document.querySelector("#seventh_context canvas");
  const context = canvas.getContext("2d");
...
https://thisismagma.com/assets/home/lore/seq/136.webp?2
  ...
  gsap.to(imageSeq, {
    ...
    scrollTrigger: {
      scrub: .5,
      trigger: `#seventh_context canvas`,
      start: `top top`,
      end: `250% top`,
      scroller: `#container`,
    },
...
gsap.to(".seventh_context-circle_inner",{
  scrollTrigger:{
    trigger:`.seventh_context-circle_inner`,
    start: `top center`,
    end: `bottom top`,
    // markers: true,
    scroller:`#container`,
